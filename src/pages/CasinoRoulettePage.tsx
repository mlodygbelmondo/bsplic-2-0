...
export default function CasinoRoulettePage() {
  ...
  return (
    <div
      ...
      style={{
        '--casino-bg-desktop': "url('/casino/roulette-table.webp')",
        '--casino-bg-mobile': "url('/casino/roulette-table.webp')",
      } as CasinoBackgroundStyle}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.14),transparent_35%),linear-gradient(180deg,rgba(3,16,10,0.20),rgba(3,16,10,0.38)_55%,rgba(3,16,10,0.68))]" />
      <div className="relative z-10 mx-auto w-full max-w-[1800px] p-4 pb-10 pt-1.5 md:p-6 md:pb-14">
        <CasinoLobby
          userId={user.id}
