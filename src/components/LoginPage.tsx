  ...
  return (
    <div className="min-h-screen bg-primary relative overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 -right-20 w-96 h-96 opacity-10" style={{
          background: 'repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(255,255,255,0.1) 10px, rgba(255,255,255,0.1) 20px)',
        }} />
        <div className="absolute top-0 left-1/4 w-[600px] h-[200px] opacity-[0.07]" style={{
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-card rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="relative">
                <div className="bg-muted rounded-xl px-4 pt-3 pb-2">
            ...
            <div className="relative">
              <div className="bg-muted rounded-xl px-4 pt-3 pb-2">
                <label className="block text-xs text-muted-foreground mb-0.5">E-mail lub login</label>
                <input
                  type="email"
                  value={email}
            ...
            <div className="relative">
              <div className="bg-muted rounded-xl px-4 pt-3 pb-2 flex items-center">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="text-muted-foreground ml-2">
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="w-full h-12 rounded-xl text-base font-bold gradient-primary text-primary-foreground shadow-lg"
            >
          ...
          {isLogin && (
            <button className="w-full text-center mt-4 text-sm font-semibold text-primary hover:underline">
              Nie pamiętasz hasła?
            </button>
          )}
        </div>
