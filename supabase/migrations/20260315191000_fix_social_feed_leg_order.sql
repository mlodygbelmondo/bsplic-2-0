-- Fix social/profile coupon history RPCs ordering by a non-existent alias field.
-- Previous implementation used `ORDER BY leg.created_at` where `created_at`
-- was not selected in the `leg` subquery, causing runtime RPC errors.
