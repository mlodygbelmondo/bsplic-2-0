-- Per-game payout calibration targeting ~90% regular-game return including free spins.
-- Global inactivity lucky shot remains an additional, separately disclosed bonus.
