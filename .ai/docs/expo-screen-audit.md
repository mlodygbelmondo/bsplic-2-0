...
| 6 | Dolny dock | 5 tabów, selected, scroll-hide, safe area, casino tone | partial | 5 tabów, selected, safe area i casino tone potwierdzone na sportsbook, ruletce i blackjacku. Eksperymentalną zmianę scroll-hide cofnięto na wyraźne żądanie użytkownika do zaakceptowanego checkpointu; dlatego wymóg scroll-hide z kontraktu pozostaje świadomie niespełniony, zamiast być fałszywie raportowany jako pass. |
...
| 24 | Own profile | dark, light, loading, error, player card, stats, badges, histories, avatar actions | partial | Side-by-side dark/light: naprawiono kontrast karty gracza i pełny katalog odznak. Avatar jest iteracyjnie kompresowany do backendowego limitu 140000 B; upload nie został wykonany na koncie QA, a wymuszone error/loading pozostają bez ręcznego dowodu. |
